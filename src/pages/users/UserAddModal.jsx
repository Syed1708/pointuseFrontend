        ...
        <div>
          ...
          <div className="mt-1 flex space-x-2">
            <input
              ...
              className="block flex-1 rounded-lg border border-zinc-200 p-2 text-sm focus:border-zinc-900 focus:outline-none"
            />
            <button
              type="button"
              onClick={handleGeneratePin}
              className="rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2 text-xs font-semibold text-zinc-700 hover:bg-zinc-100 transition shadow-sm"
            >
              Generate
            </button>
          </div>
